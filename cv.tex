...
\item DLR, Göttingen, Germany (November 2017--January 2018). Implementation of modern models of physico-chemical process rates in the DLR-TAU solver.
...
\item Khristianovich Institute of Theoretical and Applied Mechanics, Novosibirsk, Russia (February 2016). Worked on implementation of state-to-state models of non-equilibrium processes in DSMC code.
\end{rSubsection}
...
\begin{enumerate}
    ...
    \item Research project ``Implementation of models of vibrational transitions in direct simulation methods'', 2015--2016
