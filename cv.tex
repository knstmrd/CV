...
\address{Ph.D. (Mechanics of Fluids, Gases and Plasma)}
\address{Saint-Petersburg State University \\ Department of Hydroaeromechanics}
\address{+79533767636 \\ kunstmord@kunstmord.com} % Your phone number and email
...
\item Programming (Python, MAX/MSP)
...
\item Well-acquainted with numerical libraries for C++ (GSL, Armadillo) and Python (Numpy, Scipy)
\end{rSubsection}
...
% \begin{rSection}{Kaggle competition participation and results}
...
Co-author of 9 publications in SCOPUS/Web of Science-indexed peer-reviewed journals, participant of 5 international and 6 all-Russian conferences.
...
\item  \emph{Shoev, G. V., Ye A. Bondar, G. P. Oblapenko, and E. V. Kustova.} Development and testing of a numerical simulation method for thermally nonequilibrium dissociating flows in ANSYS Fluent // Thermophysics and Aeromechanics, 2016. Vol. 23, no. 2. P. 151-163
