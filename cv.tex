...
\leftheader{%
  {\LARGE\bfseries\sffamily Dr. Georgii Oblapenko}
    ...
    Born on 10 February 1992 \\
    \\
    Chair of Applied \& Computational Mathematics (ACoM), RWTH Aachen, Schinkelstraße 2, 52062 Aachen, Germany
\\
    
  \makefield{\faPhone[regular]}{{\texttt{+49-0174-476-9489}}}

  \makefield{\faEnvelope[regular]}{\href{georgii.oblapenko@fastmail.com}{\texttt{oblapenko@acom.rwth-aachen.de}}}
...
\makefield{\faGlobe}{{\texttt{Languages: English (fluent), German (fluent, including technical German), Russian (native speaker)}}}
  
\makefield{}{\newline Researcher with 10+ years of experience in the field of numerical model development for simulation of non-equilibrium flows.}
